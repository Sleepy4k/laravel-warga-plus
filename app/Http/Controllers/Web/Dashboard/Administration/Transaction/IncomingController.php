...
use App\Http\Requests\Web\Dashboard\Administration\Transaction\Incoming\StoreRequest;
use App\Http\Requests\Web\Dashboard\Administration\Transaction\Incoming\UpdateRequest;
use App\Models\Letter;
use App\Policies\Web\Administration\Transaction\IncomingPolicy;
use App\Services\Web\Dashboard\Administration\Transaction\IncomingService;
...
class IncomingController extends Controller
{
    ...
    {
        return view('pages.dashboard.administration.transaction.incoming.index', $this->service->index());
    }
