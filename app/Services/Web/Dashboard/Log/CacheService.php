...
class CacheService extends Service
{
    ...
    public function index(): array
    {
        ...
        $fileList = LogReader::getFileList(LogReaderType::DAILY, 'cache');
    ...
    public function store(mixed $data): bool
    {
        ...
        try {
            ...
            $this->sendReportLog(ReportLogType::ERROR, 'Failed to clear cache logs: ' . $th->getMessage(), [
                'data' => $data,
            ]);
            return false;
        }
