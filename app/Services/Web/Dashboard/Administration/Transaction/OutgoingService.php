...
class OutgoingService extends Service
{
    ...
    public function index(): array
    {
        ...
        $data = Letter::where('type', LetterType::OUTGOING)
            ->with([
    ...
    public function store(array $request): bool
    {
        try {
            ...
            DB::rollBack();
            $this->sendReportLog(ReportLogType::ERROR, 'Failed to create outgoing letter: ' . $th->getMessage(), [
                'request' => $request,
            ]);
            return false;
        }
    ...
    public function update(array $request, Letter $letter): bool
    {
        try {
            ...
            DB::rollBack();
            $this->sendReportLog(ReportLogType::ERROR, 'Failed to update outgoing letter: ' . $th->getMessage(), [
                'request' => $request,
                'letter_id' => $letter->id
            ]);
            return false;
    ...
    public function destroy(Letter $letter): bool
    {
        try {
            ...
            $this->sendReportLog(ReportLogType::ERROR, 'Failed to delete outgoing letter: ' . $th->getMessage(), [
                'letter_id' => $letter->id
            ]);
            return false;
        }
