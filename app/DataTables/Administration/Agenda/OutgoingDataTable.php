...
class OutgoingDataTable extends DataTable
{
    /**
    ...
    public function query(Letter $model): QueryBuilder
    {
        ...
        return $model->where('type', LetterType::OUTGOING)
            ->select('id', 'reference_number', 'agenda_number', 'letter_date', 'received_date', 'to', 'classification_id', 'created_at')
