...
class StatusDataTable extends DataTable
{
     ...
     *
     * @param QueryBuilder<LetterStatus> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        $buttons = [
            'show' => [
                'permission' => 'letter_references.status.show',
                'class' => 'btn-info show-record',
                'icon' => 'fa-circle-info',
                'target' => '#show-record',
            ],
            'edit' => [
                'permission' => 'letter_references.status.edit',
                'class' => 'btn-warning edit-record',
                'icon' => 'fa-pen-to-square',
                'target' => '#edit-record',
            ],
            'delete' => [
                'permission' => 'letter_references.status.delete',
     ...
     *
     * @return QueryBuilder<LetterStatus>
     */
    public function query(LetterStatus $model): QueryBuilder
    {
        return $model->select('id', 'status', 'created_at', 'updated_at');
    }
    ...
    {
        return 'Reference_Status_' . date('YmdHis');
    }
}
