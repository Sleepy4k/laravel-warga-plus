...
class ArticleCategoryDataTable extends DataTable
{
     ...
     *
     * @param QueryBuilder<ArticleCategory> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        $buttons = [
            'show' => [
                'permission' => 'article.category.show',
                'class' => 'btn-info show-record',
                'icon' => 'fa-circle-info',
                'target' => '#show-record',
            ],
            'edit' => [
                'permission' => 'article.category.edit',
                'class' => 'btn-warning edit-record',
                'icon' => 'fa-pen-to-square',
                'target' => '#edit-record',
            ],
            'delete' => [
                'permission' => 'article.category.delete',
     ...
     *
     * @return QueryBuilder<ArticleCategory>
     */
    ...
    {
        return 'Article_Category_' . date('YmdHis');
    }
}
