...
class QueryDetailDataTable extends DataTable
{
    /**
     * Init log file.
     *
    ...
    public function customData()
    {
        ...
        return collect(
            (object) LogReader::getFileContent('query-'.$date)
        );
    }
    ...
    {
        return 'Query_Detail_Log_' . date('YmdHis');
    }
}
