...
class CacheDetailDataTable extends DataTable
{
    /**
     * Init log file.
     *
    ...
    public function customData()
    {
        ...
        return collect(
            (object) LogReader::getFileContent('cache-'.$date)
        );
    }
    ...
    {
        return 'Cache_Detail_Log_' . date('YmdHis');
    }
}
