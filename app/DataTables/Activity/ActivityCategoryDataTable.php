...
class ActivityCategoryDataTable extends DataTable
{
    /**
     * Build the DataTable class.
     *
     * @param QueryBuilder<ActivityCategory> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        $buttons = [
            'show' => [
                'permission' => 'activity.category.show',
            ...
            'delete' => [
                'permission' => 'activity.category.delete',
     ...
     *
     * @return QueryBuilder<ActivityCategory>
     */
    public function query(ActivityCategory $model): QueryBuilder
    {
        return $model
    ...
    {
        return $this->builder()
            ->setTableId('activity-category-table')
    ...
    {
        return 'Activity_Category_' . date('YmdHis');
    }
}
