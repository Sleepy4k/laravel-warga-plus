<!DOCTYPE html>
<html dir="ltr" data-assets-path="{{ config('app.url') }}/" class="layout-navbar-fixed dark-style"
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('vendor/css/pages/front.css') }}" class="template-customizer-theme-css"
            @cspNonce />
        ...
        <link rel="stylesheet" href="{{ asset('vendor/css/pages/front-landing.css') }}" class="template-customizer-theme-css"
            @cspNonce />
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="nav-theme-text">
                    <li>
                      <button type="button" class="dropdown-item align-items-center" data-bs-theme-value="light" aria-pressed="false">
                        <span>
                          <i class="icon-base bx bx-sun icon-md me-3" data-icon="sun"></i>Light </span>
                      </button>
                    </li>
                    <li>
                      <button type="button" class="dropdown-item align-items-center" data-bs-theme-value="dark" aria-pressed="false">
                        <span>
                          <i class="icon-base bx bx-moon icon-md me-3" data-icon="moon"></i>Dark </span>
                      </button>
                    </li>
                    <li>
                      <button type="button" class="dropdown-item align-items-center active" data-bs-theme-value="system" aria-pressed="true">
                        <span>
                          <i class="icon-base bx bx-desktop icon-md me-3" data-icon="desktop"></i>System </span>
                      </button>
                    </li>
                  </ul>
                </li>
              ...
              <div class="row gx-0 gy-6 g-lg-10">
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li class="mb-4">
                      <a href="payment-page.html" class="footer-link">Payment <span class="badge bg-primary ms-2">New</span>
                      </a>
                    </li>
                    <li class="mb-4">
