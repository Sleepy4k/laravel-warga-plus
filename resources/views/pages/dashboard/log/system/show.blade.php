<x-layouts.dashboard title="Detail System Log">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('dashboard.log.system.index') }}" class="btn btn-primary">
                <i class="fa-solid fa-arrow-left"></i><span class="ms-2">Back to System Logs</span>
            </a>
        </div>
