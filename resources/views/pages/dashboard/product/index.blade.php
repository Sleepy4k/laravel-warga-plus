<x-layouts.dashboard title="Product">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            @can('product.create')
                <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#add-new-record"
                    aria-controls="add-new-record">Create Product
                </button>
            @endcan
        </div>

        <div class="row" id="product-stats">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <span id="text-product">&nbsp{{ Str::plural('Product', $totalProduct) }}</span>
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <span id="total-available">{{ $totalAvailable }}</span>
                            <span id="text-available">&nbsp{{ Str::plural('Product', $totalAvailable) }}</span>
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Total Not Available</h5>
                        <p class="card-text">
                            <span id="total-not-available">{{ $totalNotAvailable }}</span>
                            <span id="text-not-available">&nbsp{{ Str::plural('Product', $totalNotAvailable) }}</span>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <x-dashboard.canvas.wrapper canvasId="add-new-record" canvasPermission="product.create">
            ...
            <x-dashboard.canvas.body>
                <form class="add-new-record pt-0 row g-2" id="form-add-new-record" method="POST"
                    action="{{ route('dashboard.product.store') }}" enctype="multipart/form-data">
                    <div class="col-sm-12">
                        <label class="form-label" for="name">Name</label>
                        <div class="input-group input-group-merge">
                            <input type="text" id="name"
                                class="form-control dt-name @error('name') is-invalid @enderror" name="name"
                                placeholder="Sate Lilit" aria-label="Sate Lilit" aria-describedby="name"
                                value="{{ old('name') }}" />
                        </div>
                    </div>
                    <div class="col-sm-12">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="text" id="description" name="description"
                                ...
                                placeholder="Sate Khas Bali" aria-label="Sate Khas Bali" aria-describedby="description"
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="number" id="price" name="price"
                                class="form-control dt-price @error('price') is-invalid @enderror" placeholder="12000"
                                aria-label="12000" aria-describedby="price" value="{{ old('price') }}" />
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <label class="form-label" for="is_available">Available</label>
                        <div class="input-group input-group-merge">
                            <select class="form-select @error('is_available') is-invalid @enderror" id="is_available"
                                name="is_available">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="number" id="rating" name="rating"
                                class="form-control dt-rating @error('rating') is-invalid @enderror" placeholder="4.5"
                                aria-label="4.5" aria-describedby="rating" step="0.1" min="0.0"
                                max="5.0" value="{{ old('rating') }}" />
                        </div>
                    </div>
                    <div class="col-sm-12">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="text" id="location" name="location"
                                class="form-control dt-location @error('location') is-invalid @enderror"
                                placeholder="Bali, Indonesia" aria-label="Bali, Indonesia"
        ...
        <x-dashboard.canvas.wrapper canvasId="show-record" canvasPermission="product.show">
            ...
            <x-dashboard.canvas.body>
                <div class="row g-2">
                    <div class="col-sm-12">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="text" id="show-name" class="form-control dt-name"
                                placeholder="Sate Lilit" aria-label="Sate Lilit" aria-describedby="show-name"
                                disabled />
                        </div>
                    </div>
                    <div class="col-sm-12">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="text" id="show-description" class="form-control dt-description"
                                placeholder="Sate Khas Bali" aria-label="Sate Khas Bali"
                                aria-describedby="show-description" disabled />
                        </div>
                    </div>
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <label class="form-label" for="show-price">Price</label>
                        <div class="input-group input-group-merge">
                            <input type="number" id="show-price" class="form-control dt-price" placeholder="12000"
                                aria-label="12000" aria-describedby="show-price" disabled />
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <label class="form-label" for="show-available">Available</label>
                        <div class="input-group input-group-merge">
                            <input type="text" id="show-available" class="form-control dt-available"
                                placeholder="Yes" aria-label="Yes" aria-describedby="show-available" disabled />
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <label class="form-label" for="show-location">Location</label>
                        <div class="input-group input-group-merge">
                            <input type="text" id="show-location" class="form-control dt-location"
                                placeholder="Purwokerto, Banyumas, Jawa Tengah"
                                aria-label="Purwokerto, Banyumas, Jawa Tengah" aria-describedby="show-location"
                                disabled />
                        </div>
                    </div>
                    <div class="col-sm-12">
        ...
        <x-dashboard.canvas.wrapper canvasId="edit-record" canvasPermission="product.edit">
            ...
            <x-dashboard.canvas.body>
                <form class="add-new-record pt-0 row g-2" id="form-edit-record" method="PUT" action="#"
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="number" id="edit-price" name="price"
                                class="form-control dt-price @error('price') is-invalid @enderror"
                                placeholder="12000" aria-label="12000" aria-describedby="price" />
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <label class="form-label" for="edit-is_available">Available</label>
                        <div class="input-group input-group-merge">
                            <select class="form-select @error('is_available') is-invalid @enderror"
                                id="edit-is_available" name="is_available">
                                <option value="1">Yes</option>
                                <option value="0">No</option>
                            </select>
                        </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="number" id="edit-rating" name="rating"
                                class="form-control dt-rating @error('rating') is-invalid @enderror"
                                placeholder="4.5" aria-label="4.5" aria-describedby="rating" step="0.1"
                                min="0" max="5" />
                        </div>
                    </div>
                    <div class="col-sm-12">
    ...
    @pushOnce('page-scripts')
        ...
        @endcanany
        @canany(['product.create', 'product.edit', 'product.show', 'product.delete'])
            ...
            <script @cspNonce>
                $(document).ready(function() {
                    const crudManager = new CrudManager({
                        ...
                        routes: {
                            update: "{{ route('dashboard.product.update', ':id') }}",
                            destroy: "{{ route('dashboard.product.destroy', ':id') }}"
                        },
                        offcanvas: {
                            show: {
                                id: '#show-record',
                                ...
                                fieldMapBehavior: {
                                    ...
                                    price: function(el, data, rowData) {
                                        el.val(rowData.detail.price);
                                    },
                                    is_available: function(el, data, rowData) {
                                        el.val(rowData.detail.is_available ? 'Yes' : 'No');
                                    },
                                    location: function(el, data, rowData) {
                                        el.val(rowData.detail.location);
                                    },
                                    image: function(el, data, rowData) {
                                        if (rowData.detail.image_url) {
                                            el.attr('src', rowData.detail.image_url);
                                        }
                                    }
                                }
                            },
                            edit: {
                                ...
                                fieldMapBehavior: {
                                    category_id: function(el, data, rowData) {
                                        el.val(rowData.category_id).trigger('change');
                                    },
                                    price: function(el, data, rowData) {
                                        el.val(rowData.detail.price);
                                    },
                                    is_available: function(el, data, rowData) {
                                        el.val(rowData.detail.is_available.toString().toLowerCase() === "ya" ?
                                            '1' : '0').trigger('change');
                                    },
                                    rating: function(el, data, rowData) {
                                        el.val(rowData.detail.rating);
                                    },
                                    location: function(el, data, rowData) {
                                        el.val(rowData.detail.location);
                                    },
                                    image: function(el, data, rowData) {
                                        if (rowData.detail.image_url) {
                                            el.attr('src', rowData.detail.image_url).removeClass('d-none');
                        ...
                        onSuccess: function(response, formId) {
                            ...
                            const totalProduct = response.data.totalProduct || 0;
                            const totalAvailable = response.data.totalAvailable || 0;
                            const totalNotAvailable = response.data.totalNotAvailable || 0;
                            const totalCategory = response.data.totalCategory || 0;
                            $('#product-stats #total-product').text(totalProduct);
                            $('#product-stats #text-product').html(getPluralText(totalProduct, 'Product',
                                'Products'));
                            $('#product-stats #total-available').text(totalAvailable);
                            $('#product-stats #text-available').html(getPluralText(totalAvailable, 'Product',
                                'Products'));
                            $('#product-stats #total-not-available').text(totalNotAvailable);
                            $('#product-stats #text-not-available').html(getPluralText(totalNotAvailable,
                                'Product', 'Products'));
                            $('#product-stats #total-category').text(totalCategory);
                            $('#product-stats #text-category').html(getPluralText(totalCategory, 'Category',
                                'Categories'));
