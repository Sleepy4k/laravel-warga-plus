<x-layouts.dashboard title="Outgoing Letter">
    @pushOnce('plugin-styles')
        ...
        @canany(['letter_transaction.outgoing.create', 'letter_transaction.outgoing.edit'])
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            @can('letter_transaction.outgoing.create')
            ...
            <div class="card text-center">
                <div class="card-body py-5">
                    ...
                    <p class="card-text text-muted mb-4">
                        There are no outgoing letters to display at the moment.
                    </p>
                    @can('letter_transaction.outgoing.create')
        ...
        <x-dashboard.canvas.wrapper canvasId="add-new-record" canvasPermission="letter_transaction.outgoing.create">
            ...
            <x-dashboard.canvas.body>
                <form class="add-new-record pt-0 row g-2" id="form-add-new-record" method="POST"
                    action="{{ route('dashboard.letter.transaction.outgoing.store') }}" enctype="multipart/form-data">
                    <div class="col-sm-6">
        ...
        <x-dashboard.canvas.wrapper canvasId="show-record" canvasPermission="letter_transaction.outgoing.show">
            ...
            <x-dashboard.canvas.body>
                <div class="row g-2" id="show-record-content">
                    ...
                    <div class="col-sm-12">
                        <label class="form-label" for="show-to">To</label>
                        <div class="input-group input-group-merge">
                            <input type="text" id="show-to" class="form-control" readonly />
                        </div>
                    </div>
                    <div class="col-sm-6">
        ...
        <x-dashboard.canvas.wrapper canvasId="edit-record" canvasPermission="letter_transaction.outgoing.edit">
            ...
            <x-dashboard.canvas.body>
                <form class="add-new-record pt-0 row g-2" id="form-edit-record" method="PUT" action="#">
                    ...
                    <div class="col-sm-12">
                        <label class="form-label" for="edit-to">To</label>
                        <div class="input-group input-group-merge">
    ...
    @pushOnce('page-scripts')
        <script @cspNonce>
            $(document).ready(function() {
                const baseUrl = "{{ route('dashboard.letter.transaction.outgoing.index') }}";
        ...
        @canany(['letter_transaction.outgoing.create', 'letter_transaction.outgoing.edit'])
            ...
            <script @cspNonce>
                ...
                $(document).ready(function() {
                    ...
                    @can('letter_transaction.outgoing.edit')
        ...
        @endcanany
        @canany(['letter_transaction.outgoing.create', 'letter_transaction.outgoing.edit',
            'letter_transaction.outgoing.show', 'letter_transaction.outgoing.delete'])
            ...
            <script @cspNonce>
                $(document).ready(function() {
                    const crudManager = new CrudManager({
                        ...
                        routes: {
                            update: "{{ route('dashboard.letter.transaction.outgoing.update', ':id') }}",
                            destroy: "{{ route('dashboard.letter.transaction.outgoing.destroy', ':id') }}"
                        },
                        findFunction: (id) => {
