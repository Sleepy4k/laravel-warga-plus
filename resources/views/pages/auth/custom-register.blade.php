<x-layouts.auth title="Complete Registration">
                ...
                <div class="w-px-700">
                    <div id="multiStepsValidation" class="bs-stepper shadow-none">
                        ...
                        <div class="bs-stepper-content">
                            <form id="multiStepsForm" action="{{ route('register.complete.store') }}" method="POST">
                                @csrf

                                <div id="accountDetailsValidation" class="content"></div>

                                <x-auth.register.personal-info :isCustomRegistration="true" />
    ...
    @pushOnce('page-scripts')
        <script type="text/javascript" src="{{ asset('js/pages/auth-complete-multisteps.min.js') }}" @cspNonce></script>
