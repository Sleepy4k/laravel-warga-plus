<x-layouts.landing>
    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
        <section id="hero-animation">
            ...
            <img src="{{ asset('img/front-pages/backgrounds/hero-bg.png') }}" alt="hero background" class="position-absolute top-0 start-50 translate-middle-x object-fit-cover w-100 h-100" data-speed="1">
            <div class="container">
                <div class="hero-text-box text-center position-relative">
                <h1 class="text-primary hero-title display-6 fw-extrabold">One dashboard to manage all your businesses</h1>
                <h2 class="hero-sub-title h6 mb-6"> Production-ready &amp; easy to use Admin Template <br class="d-none d-lg-block"> for Reliability and Customizability. </h2>
                <div class="landing-hero-btn d-inline-block position-relative">
                    <span class="hero-btn-item position-absolute d-none d-md-flex fw-medium">Join community <img src="../../assets/img/front-pages/icons/Join-community-arrow.png" alt="Join community arrow" class="scaleX-n1-rtl">
                    </span>
                ...
                <a href="../vertical-menu-template/app-ecommerce-dashboard.html" target="_blank">
                    <div id="heroAnimationImg" class="position-relative hero-dashboard-img" style="transform: perspective(1200px) rotateX(-0.5deg) rotateY(-2.84deg) scale3d(1, 1, 1);">
                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/landing-page/hero-dashboard-dark.png" alt="hero dashboard" class="animation-img" data-app-light-img="front-pages/landing-page/hero-dashboard-light.png" data-app-dark-img="front-pages/landing-page/hero-dashboard-dark.png" style="visibility: visible;">
                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/landing-page/hero-elements-dark.png" alt="hero elements" class="position-absolute hero-elements-img animation-img top-0 start-0" data-app-light-img="front-pages/landing-page/hero-elements-light.png" data-app-dark-img="front-pages/landing-page/hero-elements-dark.png" style="visibility: visible; transform: translateZ(1rem);">
                    </div>
                </a>
                </div>
            </div>
        ...
        <section id="landingFeatures" class="section-py landing-features">
            ...
            <h4 class="text-center mb-1">
                <span class="position-relative fw-extrabold z-1">Everything you need <img src="../../assets/img/front-pages/icons/section-title-icon.png" alt="laptop charging" class="section-title-img position-absolute object-fit-contain bottom-0 z-n1">
                </span> to start your next project
            </h4>
        ...
        <section id="landingReviews" class="section-py bg-body landing-reviews pb-0">
            ...
            <div class="row align-items-center gx-0 gy-4 g-lg-5 mb-5 pb-md-5">
                ...
                <h4 class="mb-1">
                    <span class="position-relative fw-extrabold z-1">What people say <img src="../../assets/img/front-pages/icons/section-title-icon.png" alt="laptop charging" class="section-title-img position-absolute object-fit-contain bottom-0 z-n1">
                    </span>
                </h4>
                <p class="mb-5 mb-md-12"> See what our customers have to <br class="d-none d-xl-block"> say about their experience. </p>
                ...
                <div class="swiper-reviews-carousel overflow-hidden">
                    ...
                    <div class="swiper-wrapper" id="swiper-wrapper-5b768238ec4ed956" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-1396px, 0px, 0px); transition-delay: 0ms;">
                        <div class="swiper-slide" style="width: 344px; margin-right: 5px;" role="group" aria-label="5 / 6" data-swiper-slide-index="4">
                        ...
                        <div class="swiper-slide" role="group" aria-label="6 / 6" style="width: 344px; margin-right: 5px;" data-swiper-slide-index="5">
                        <div class="card h-100">
                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                            <div class="mb-4">
                        ...
                        <div class="swiper-slide" style="width: 344px; margin-right: 5px;" role="group" aria-label="1 / 6" data-swiper-slide-index="0">
                        <div class="card h-100">
                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                            <div class="mb-4">
                        ...
                        <div class="swiper-slide swiper-slide-prev" style="width: 344px; margin-right: 5px;" role="group" aria-label="2 / 6" data-swiper-slide-index="1">
                        <div class="card h-100">
                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                            <div class="mb-4">
                        ...
                        <div class="swiper-slide swiper-slide-active" style="width: 344px; margin-right: 5px;" role="group" aria-label="3 / 6" data-swiper-slide-index="2">
                        <div class="card h-100">
                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                            <div class="mb-4">
                        ...
                        <div class="swiper-slide swiper-slide-next" style="width: 344px; margin-right: 5px;" role="group" aria-label="4 / 6" data-swiper-slide-index="3">
                        <div class="card h-100">
                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                            <div class="mb-4">
                    ...
                    <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-5b768238ec4ed956"></div>
                    <div class="swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-5b768238ec4ed956"></div>
            ...
            <div class="swiper-logo-carousel pt-8">
                ...
                <div class="swiper-wrapper" id="swiper-wrapper-8a5e16345a69e8f2" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-458.667px, 0px, 0px); transition-delay: 0ms;">
                    <div class="swiper-slide" style="width: 229.333px;" role="group" aria-label="1 / 5">
                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/branding/logo_1-dark.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo_1-light.png" data-app-dark-img="front-pages/branding/logo_1-dark.png" style="visibility: visible;">
                    </div>
                    <div class="swiper-slide swiper-slide-prev" style="width: 229.333px;" role="group" aria-label="2 / 5">
                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/branding/logo_2-dark.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo_2-light.png" data-app-dark-img="front-pages/branding/logo_2-dark.png" style="visibility: visible;">
                    </div>
                    <div class="swiper-slide swiper-slide-active" style="width: 229.333px;" role="group" aria-label="3 / 5">
                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/branding/logo_3-dark.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo_3-light.png" data-app-dark-img="front-pages/branding/logo_3-dark.png" style="visibility: visible;">
                    </div>
                    <div class="swiper-slide swiper-slide-next" style="width: 229.333px;" role="group" aria-label="4 / 5">
                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/branding/logo_4-dark.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo_4-light.png" data-app-dark-img="front-pages/branding/logo_4-dark.png" style="visibility: visible;">
                    </div>
                    <div class="swiper-slide" role="group" aria-label="5 / 5" style="width: 229.333px;">
                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/branding/logo_5-dark.png" alt="client logo" class="client-logo" data-app-light-img="front-pages/branding/logo_5-light.png" data-app-dark-img="front-pages/branding/logo_5-dark.png" style="visibility: visible;">
                    </div>
                </div>
                <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
                </div>
        ...
        <section id="landingTeam" class="section-py landing-team">
            ...
            <h4 class="text-center mb-1">
                <span class="position-relative fw-extrabold z-1">Supported <img src="../../assets/img/front-pages/icons/section-title-icon.png" alt="laptop charging" class="section-title-img position-absolute object-fit-contain bottom-0 z-n1">
                </span> by Real People
            </h4>
        ...
        <section id="landingPricing" class="section-py bg-body landing-pricing">
            ...
            <h4 class="text-center mb-1">
                <span class="position-relative fw-extrabold z-1">Tailored pricing plans <img src="../../assets/img/front-pages/icons/section-title-icon.png" alt="laptop charging" class="section-title-img position-absolute object-fit-contain bottom-0 z-n1">
        ...
        <section id="landingFAQ" class="section-py bg-body landing-faq">
            ...
            <h4 class="text-center mb-1"> Frequently asked <span class="position-relative fw-extrabold z-1">questions <img src="../../assets/img/front-pages/icons/section-title-icon.png" alt="laptop charging" class="section-title-img position-absolute object-fit-contain bottom-0 z-n1">
                </span>
            </h4>
        ...
        <section id="landingCTA" class="section-py landing-cta position-relative p-lg-0 pb-0">
            <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/front-pages/backgrounds/cta-bg-dark.png" class="position-absolute bottom-0 end-0 scaleX-n1-rtl h-100 w-100 z-n1" alt="cta image" data-app-light-img="front-pages/backgrounds/cta-bg-light.png" data-app-dark-img="front-pages/backgrounds/cta-bg-dark.png" style="visibility: visible;">
            <div class="container">
        ...
        <section id="landingContact" class="section-py bg-body landing-contact">
            ...
            <h4 class="text-center mb-1">
                <span class="position-relative fw-extrabold z-1">Let's work <img src="../../assets/img/front-pages/icons/section-title-icon.png" alt="laptop charging" class="section-title-img position-absolute object-fit-contain bottom-0 z-n1">
                </span> together
            </h4>
            ...
            <div class="row g-6">
                ...
                <div class="card h-100">
                    ...
                    <p class="mb-6"> If you would like to discuss anything related to payment, account, licensing, <br class="d-none d-lg-block"> partnerships, or have pre-sales questions, you’re at the right place. </p>
                    <form>
                        <div class="row g-4">
                        <div class="col-md-6">
                            <label class="form-label" for="contact-form-fullname">Full Name</label>
                            <input type="text" class="form-control" id="contact-form-fullname" placeholder="john" spellcheck="false" data-ms-editor="true">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="contact-form-email">Email</label>
                            <input type="text" id="contact-form-email" class="form-control" placeholder="johndoe@gmail.com" spellcheck="false" data-ms-editor="true">
                        </div>
                        <div class="col-12">
                            <label class="form-label" for="contact-form-message">Message</label>
                            <textarea id="contact-form-message" class="form-control" rows="11" placeholder="Write a message" spellcheck="false" data-ms-editor="true"></textarea>
                        </div>
                        <div class="col-12">
