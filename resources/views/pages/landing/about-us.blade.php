<x-layouts.landing title="Tentang Kami">
    ...
    <section class="section-py">
        <div class="container">
            ...
            <div class="card shadow-sm border-0 mx-auto" style="max-width:900px; overflow:auto;">
                <div class="card-body py-3">
                    <p class="mb-0 text-muted fs-4" style="text-align: justify;">
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                button.addEventListener('click', () => {
                    ...
                    if (ourMissionSection) {
                        ourMissionSection.scrollIntoView({ behavior: 'smooth' });
                    }
                });
            });
        </script>
